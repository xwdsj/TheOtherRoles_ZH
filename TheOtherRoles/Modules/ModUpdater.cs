    ...
    public class ModUpdater { 
        ...
        public static async Task<bool> checkForUpdate() {
            try {
                ...
                var response = await http.GetAsync(new System.Uri("https://api.github.com/repos/xwdsj/TheOtherRoles_ZH_xwdsj/releases/latest"), HttpCompletionOption.ResponseContentRead).ConfigureAwait(false);
